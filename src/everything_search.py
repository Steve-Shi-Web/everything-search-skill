...
class EverythingSearch:
    ...
    def search_photos(self, person_name: str, formats: List[str] = None) -> SearchResult:
        """
        Search for photos of a specific person.
        
        Args:
            person_name: Person's name (e.g., "史周平")
    ...
    def search_documents(self, keyword: str, doc_types: List[str] = None) -> SearchResult:
        """
